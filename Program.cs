...
namespace LineComparison
{
    class Program
    {
        ...
        public void CompareLength(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4,double length1 , double length2)
        {
            double value = length1.CompareTo(length2);
            if(value > 0)
            {
        ...
        static void Main(string[] args)
        {
            ...
            ///Comparing length of lines using CompareTo method
            program.CompareLength(x1, y1, x2, y2, x3, y3, x4, y4, length1, length2);
        }
    }
}
